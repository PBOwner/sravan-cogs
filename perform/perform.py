...
class Perform(commands.Cog):
    ...
    def __init__(self, bot: Red):
        ...
        default_global = {
            ...
            "sip": [
                "https://tenor.com/blQIA.gif",
                "https://tenor.com/k83FISA4233.gif",
                "https://tenor.com/fcdWtW55kTF.gif",
                "https://tenor.com/bmbBj.gif",
                "https://tenor.com/bM6lu.gif",
                "https://tenor.com/bwg9p.gif",
                "https://tenor.com/cPlFVulytTy.gif",
            ],
            "footer": True,
        }
        default_member = {
